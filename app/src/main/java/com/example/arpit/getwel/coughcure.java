...
public class coughcure extends AppCompatActivity {
    TextView t;
    Button b1,b2,b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coughcure);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), coughcure5lit.class);
                startActivity(i);
