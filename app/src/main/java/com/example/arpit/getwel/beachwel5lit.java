...
public class beachwel5lit extends AppCompatActivity {
    TextView t;
    Button b1,b2,b3,b4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beachwel5lit);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), beachwel.class);
                startActivity(i);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), bevet25lit.class);
                startActivity(i);
