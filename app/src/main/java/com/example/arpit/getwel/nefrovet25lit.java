...
public class nefrovet25lit extends AppCompatActivity {
    TextView t;
    Button b1,b2,b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nefrovet25lit);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), nefrovet.class);
                startActivity(i);
