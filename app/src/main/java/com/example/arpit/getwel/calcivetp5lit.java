...
public class calcivetp5lit extends AppCompatActivity {
    TextView t;
    Button b1,b2,b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calcivetp5lit);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), calcivetp.class);
                startActivity(i);
